...
export class PostsService {
  private posts: Post[] = [
    { authorId: 1, id: 1, title: 'Lorem Ipsum', name: 'Lorem Ipsum' },
    { authorId: 1, id: 2, title: 'Foo', name: 'Foo' },
    { authorId: 2, id: 3, title: 'Bar', name: 'Bar' },
    { authorId: 2, id: 4, title: 'Hello World', name: 'Hello World' },
